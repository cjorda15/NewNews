  ...
  return knex('news').del()
    .then(function () {
      ...
      return knex('news').insert([
        ...
        {id: 22, source: 'mirror',conservative:102,liberal:3, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 23, source: 'national-geographic',conservative:10,liberal:5, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 24, source: 'newsweek',conservative:1,liberal:13, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 25, source: 'new-york-magazine',conservative:10,liberal:93, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 26, source: 'reddit-r-all',conservative:13,liberal:63, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 27, source: 'the-economist',conservative:99,liberal:21, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 28, source: 'the-guardian-uk',conservative:102,liberal:55, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 29, source: 'the-huffington-post',conservative:1,liberal:93, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 30, source: 'the-new-york-times',conservative:12,liberal:99, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 31, source: 'the-telegraph',conservative:102,liberal:63, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 32, source: 'the-times-of-india',conservative:101,liberal:34, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 33, source: 'the-wall-street-journal',conservative:10,liberal:77, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 34, source: 'the-washington-post',conservative:1,liberal:88, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 35, source: 'time',conservative:43,liberal:31, created_at:knex.fn.now(), updated_at:knex.fn.now()},
        {id: 36, source: 'usa-today',conservative:10,liberal:23, created_at:knex.fn.now(), updated_at:knex.fn.now()}
